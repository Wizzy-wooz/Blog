...
<table class="sTable">
    <tr>        <th>Id</th>        <th>Commenter</th>        <th>Body</th>        <th>Post</th>        <th>Created At</th>
        <th>&nbsp;</th>
    </tr>
...
%>
    <tr class="<%=W.cycle("odd, even")%>">        <td><%=O.hp(comment, "id")%></td>        <td><%=O.hp(comment, "commenter")%></td>        <td><%=O.hp(comment, "body")%></td>        <td><%=O.hp(comment, "post_id")%></td>        <td><%=O.hp(comment, "created_at")%></td>
...
<br />
<%=W.windowStylePageLinks(paginator, R.resourcePath("comments"), 4, 11)%>
