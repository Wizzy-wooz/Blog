...
<table class="sTable">
    <tr>        <th>Id</th>        <th>Tag</th>        <th>Title</th>        <th>Content</th>        <th>Created At</th>        <th>Updated At</th>
        <th></th>
    </tr>
<%
...
%>
    <tr class="<%=W.cycle("odd, even")%>">        <td><%=O.hp(post, "id")%></td>        <td><%=O.hp(post, "name")%></td>        <td><%=O.hp(post, "title")%></td>        <td><%=O.hp(post, "content")%></td>        <td><%=O.hp(post, "created_at")%></td>        <td><%=O.hp(post, "updated_at")%></td>
        <td nowrap>
